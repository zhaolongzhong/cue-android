...
import ai.plusonelabs.BuildConfig
import ai.plusonelabs.Environment
import ai.plusonelabs.anthropic.AnthropicClient
import ai.plusonelabs.auth.TokenManager
import ai.plusonelabs.network.InstantAdapter
import ai.plusonelabs.network.JsonValueAdapter
import ai.plusonelabs.network.NetworkClient
import ai.plusonelabs.network.NetworkClientImpl
import ai.plusonelabs.network.NetworkError
import ai.plusonelabs.network.UnitAdapter
import ai.plusonelabs.openai.OpenAIClient
...
object NetworkModule {
    ...
    fun provideAnthropicModel(
        ...
        sharedPreferences: SharedPreferences,
        @Named("baseUrl") baseUrl: String,
    ): ai.plusonelabs.anthropic.AnthropicModel {
        ...
        return ai.plusonelabs.anthropic.AnthropicModel(
            apiKeyProvider = {
