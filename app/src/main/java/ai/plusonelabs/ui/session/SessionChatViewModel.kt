...
import ai.plusonelabs.Environment
import ai.plusonelabs.network.websocket.EventMessage
import ai.plusonelabs.network.websocket.WebSocketService
import ai.plusonelabs.ui.session.handlers.AgentControlEventHandler
import ai.plusonelabs.ui.session.handlers.ClientEventHandler
import ai.plusonelabs.ui.session.handlers.HandlerContext
import ai.plusonelabs.ui.session.handlers.SessionEventHandler
import ai.plusonelabs.ui.session.handlers.TaskStatusEventHandler
import ai.plusonelabs.ui.session.handlers.WebSocketEventHandler
import ai.plusonelabs.ui.session.managers.ClientManager
import ai.plusonelabs.ui.session.managers.MessageManager
import ai.plusonelabs.ui.session.managers.SessionManager
        ...
        viewModelScope.launch {
            webSocketService.connectionState.collect { state ->
                _connectionStatus.value = when (state) {
                    is ai.plusonelabs.network.websocket.ConnectionState.Connected -> "connected"
                    is ai.plusonelabs.network.websocket.ConnectionState.Connecting -> "connecting"
                    is ai.plusonelabs.network.websocket.ConnectionState.Disconnected -> "disconnected"
                    is ai.plusonelabs.network.websocket.ConnectionState.Error -> "error"
                }
            }
        }
    }
