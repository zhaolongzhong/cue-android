...
class AnthropicModel(
    ...
    private fun createClient(): AnthropicClient {
        ...
        return if (useProxy && baseUrl != null) {
            ...
            // Use custom HttpClient that proxies to our backend
            ...
            // Create SDK client with custom HttpClient
            ...
            // Use standard SDK client for direct Anthropic API
    ...
    companion object {
        ...
        /**
         * Create AnthropicModel with dynamic backend proxy using provider
         */
        ...
        /**
         * Create AnthropicModel from ClientMode configuration
         */
